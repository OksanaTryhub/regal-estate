...
const Home = () => {
  ...
  return (
    <section>
      ...
      <div className='flex flex-col max-w-[1392px] mx-auto py-3 px-3 gap-10 my-10'>
        {offerListings && offerListings.length > 0 && (
          <div>
            <div className='flex flex-col sm:items-center mb-4'>
              <h2 className='font-bold text-xl md:text-2xl lg:text-3xl'>Recent offers</h2>
              <Link
        ...
        {rentListings && rentListings.length > 0 && (
          <div>
            <div className='flex flex-col sm:items-center mb-4'>
              <h2 className='font-bold text-xl md:text-2xl lg:text-3xl'>Recent places for rent</h2>
              <Link
                to={"/search?type=rent"}
                className='text-xs sm:text-sm mb-3  text-dark-2 hover:text-gold-1 underline underline-custom hover:no-underline'
              >
        ...
        {saleListings && saleListings.length > 0 && (
          <div>
            <div className='flex flex-col sm:items-center mb-4'>
              <h2 className='font-bold text-xl md:text-2xl lg:text-3xl'>Recent places for sale</h2>
              <Link
                to={"/search?type=sale"}
                className='text-xs sm:text-sm mb-3  text-dark-2 hover:text-gold-1 underline underline-custom hover:no-underline'
              >
